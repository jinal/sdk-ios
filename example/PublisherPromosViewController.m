//
//  PublisherPromosViewController.m
//  playhaven-sdk-ios
//
...
@implementation PublisherPromosViewController

-(void)startRequest{
  [super startRequest];
  
  PHPublisherPromosRequest * request = [PHPublisherPromosRequest requestForApp:PH_TOKEN secret:PH_SECRET];
