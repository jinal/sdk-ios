//
//  PublisherTokensViewController.m
//  playhaven-sdk-ios
//
...
@implementation PublisherTokensViewController

-(void)startRequest{
  [super startRequest];
  
  PHPublisherTokensRequest * request = [PHPublisherTokensRequest requestForApp:PH_TOKEN secret:PH_SECRET];
